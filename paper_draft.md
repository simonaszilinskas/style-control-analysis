...
The two most important effects replicate almost exactly, and the accuracy gain from adding linguistic features reappears (0.637→0.638→0.643, versus 0.643→0.645→0.651 primary):
